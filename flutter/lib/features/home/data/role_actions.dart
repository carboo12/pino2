...
void openAction(BuildContext context, {
  ...
  final path = switch (action.routeKey) {
    RouteKey.quickOrder => '/quick-order/$storeId',
    RouteKey.catalog => '/catalog/$storeId',
    RouteKey.clients => '/clients/$storeId',
    RouteKey.routeBoard => '/route-board/$storeId',
    RouteKey.collections => '/collections/$storeId',
    RouteKey.returns => '/returns/$storeId',
    RouteKey.warehouse => '/warehouse/$storeId',
    RouteKey.dailyClosing => '/daily-closing/$storeId',
    RouteKey.vendorInventory => '/vendor-inventory/$storeId',
    RouteKey.salesHistory => '/sales-history/$storeId',
    RouteKey.inventoryAdjustments => '/inventory-adjustments/$storeId',
    RouteKey.preventaClients => '/preventa-clients',
    RouteKey.preventaOrder => '/preventa-order',
    RouteKey.preventaRoute => '/preventa-route',
  };
