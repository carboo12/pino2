  ...
  return (
    ...
    >
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex h-full flex-col">
        ...
        <TabsContent value="stock" className="mt-0 flex-1 p-6">
          <EmptyState
            title="Stock crítico"
            description="Productos con stock bajo — próximamente"
            icon={AlertTriangle}
          />
        </TabsContent>

        <TabsContent value="movimientos" className="mt-0 flex-1 p-6">
          <EmptyState
            title="Movimientos de inventario"
            description="Entradas, salidas y ajustes — próximamente"
            icon={History}
          />
        </TabsContent>
      </Tabs>
